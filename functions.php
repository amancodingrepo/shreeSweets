...
// WooCommerce Loop Customization
remove_action('woocommerce_before_shop_loop', 'woocommerce_output_all_notices', 10);
add_filter('loop_shop_columns', fn() => 3, 999);

// Remove ghost placeholder li before first product
 ...
 * Logic from shree-core.php for Razorpay/Shiprocket/SEO stability.
 */
...
// 4. Razorpay UX Double-Click block
add_action('wp_footer', function () {
